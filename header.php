...
<body class="home-template no-js">
    ...
    <header class="panel-cover" style="background-image: url(<?php $this->options->themeUrl('public/img/IMG_2021.jpg'); ?>)">
      	<div class="panel-main">
        	<div class="panel-main__inner panel-inverted">
        		<div class="panel-main__content">
    				<a href="/" title="前往 <?php $this->options->title(); ?> 的主页">
    					<img src="<?php $this->options->themeUrl('public/img/7539841.jpeg'); ?>" width="80" alt="<?php $this->options->title(); ?> logo" class="panel-cover__logo logo" />
    				</a>
